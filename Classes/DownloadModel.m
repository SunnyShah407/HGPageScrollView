...
- (void)setReusumData:(NSData *)reusumData
{
    ...
    //持久化到本地做真正的断点续传
     [NSKeyedArchiver archiveRootObject:_reusumData toFile:[self archievePath]];
}
...
- (NSURL *)filePathURL{
    ...
    [documentsDirectory appendString:[NSString stringWithFormat:@"/downloads/%@",self.fileName]];
